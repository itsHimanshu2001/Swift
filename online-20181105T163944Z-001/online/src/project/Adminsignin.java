...
if("aphpadmin2018".equals(user)){
    if("accessadminpage".equals(pwd)){
        Admin A = new Admin();
        A.setVisible(true);
...
JOptionPane.showMessageDialog(null, "Invalid Username or Password");// TODO add your handling code here:
